...
int main(int argc, char* argv[]){
  ...
  count_roots(
    "9 16 16 16 16 32 16 16 16 16 0 0 0 0 0 0 0 0 0 14 2 1 4 1 4 2 5 3 5 4 6 0 6 4 6 5 3 0 0 8 3 7 7 8 2 8 1 7 6 20 8 3 6 0 14", argv[0], true, n_exact, n_lower_bound, unsorted_setups);
