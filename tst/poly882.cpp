...
int main(int argc, char* argv[]){
  ...
  count_roots("8 16 32 32 16 16 16 16 16 0 0 0 0 0 0 0 0 13 2 1 2 1 3 2 4 3 5 0 5 2 4 0 0 7 4 6 6 7 3 5 1 7 1 6 6 20 8 3 6 0 7", argv[0], true, n_exact, n_lower_bound, unsorted_setups);
