...
int main(int argc, char* argv[]){
  ...
  count_roots("6 16 48 32 32 16 16 0 1 0 0 0 0 10 2 1 3 0 3 1 4 2 4 0 5 0 5 4 2 3 2 3 1 5 6 20 8 3 5 0 6", argv[0], true, n_exact, n_lower_bound, unsorted_setups);
