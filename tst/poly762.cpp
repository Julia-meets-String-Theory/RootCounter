...
int main(int argc, char* argv[]){
  ...
  count_roots("7 16 16 32 32 32 16 16 0 0 0 0 0 0 0 12 1 0 3 2 3 2 4 0 4 1 4 2 4 3 6 0 5 1 5 6 3 6 2 5 6 20 8 3 5 0 7", argv[0], true, n_exact, n_lower_bound, unsorted_setups);
